...
const RESTConfig = () => {
  ...
  const fetchConfig = async () => {
    try {
      setLoading(true);
      const response = await fetch('/api/rest/config', {
        headers: {
      ...
      if (response.ok) {
        ...
        console.error('Failed to fetch REST API configuration');
        showSnackbar('Failed to fetch REST API configuration', 'error');
      }
    } catch (error) {
  ...
  const saveConfig = async () => {
    try {
      ...
      if (response.ok) {
        ...
        console.error('Failed to save REST API configuration');
        showSnackbar('Failed to save REST API configuration', 'error');
      }
    } catch (error) {
